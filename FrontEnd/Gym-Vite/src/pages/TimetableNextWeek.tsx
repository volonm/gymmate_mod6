...
const TimetableContainer: React.FC = () => {
        ...
        const fetchTimetable = async () => {
            ...
            try {
                const response = await fetch(
                    "https://gymmate.pythonanywhere.com/api/getUserTrainingsAhead",
                    {
                        method: "GET",
                        headers: {
        ...
        return (
            <div className="d-flex flex-column align-items-center justify-content-center min-vh-100">
                ...
                <div className="empty-card">
                    ...
                    <button className="card-button-prev" onClick={handlePrev}>
                        Or go back
                    </button>
                </div>
    ...
    return (
        <div className="timetable-container min-vh-100">
            <h1 className="timetable-title">Your next week's Timetable <button className="card-button-next" onClick={handlePrev}> Previous week </button></h1>
            {trainings.map((training) => (
                <div className="training-card" key={training.training_id}>
